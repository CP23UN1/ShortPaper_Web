...
<template>
    ...
    <div class="flex flex-nowrap space-x-4 p-4 mt-[12px] justify-center items-center">
            ...
            <tbody class="text-center">
                <tr class="bg-white border-b hover:bg-gray-50 text-gray-900">
                    ...
                    <td class="font-medium whitespace-nowrap">
                        Ethical Considerations in Artificial Intelligence and Machine Learning Algorithms
                    </td>
                    <td class="font-medium whitespace-nowrap">
                        ธิดาพร ช.
                    </td>
                    ...
                    <td class="font-medium whitespace-nowrap">
                        <svg width="18" height="18" viewBox="0 0 20 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
